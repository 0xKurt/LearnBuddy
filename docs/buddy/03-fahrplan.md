...
| Kostenlos (Server)                         | offenes Lautmodell (wav2vec2) + espeak-ng auf eigenem EU-Server, alle 6 Sprachen (EN, FR, IT, ES, RU, DE); grob ≈ 0,005 Cent pro Satz, ~1 s                                                                                                                                                                                                                                                                                                                                                                                                                                                          | ❓ braucht Test                                       |
| Getestet                                   | PocketSphinx: unbrauchbar. Allosaurus: mit Roboter-Testaufnahmen nicht aussagekräftig                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | ✅                                                    |
| Rückfall heute (Server)                    | Gemini 3.1 Flash-Lite hört zu: ≈ 0,09 Cent pro Satz, ≈ 2,8 s; in 3 Läufen Akzent und falsches Wort als „nochmal“ erkannt (nur Computerstimmen)                                                                                                                                                                                                                                                                                                                                                                                                                                                       | ✅                                                    |
| ZIPA (Lautmodell auf dem Handy)            | **verworfen (26.09.)**: zu viel Aufwand (6–8 Wochen), 70 MB                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | —                                                     |
| **Vosk offline (Plan des Product Owners)** | Spracherkennung auf dem Gerät, aber nur mit einer kurzen Auswahlliste: Zielwort + typische Verwechslungen („through / true / threw“) + „unbekannt“. Die Verwechslungen schreibt unser Modell beim Vorbereiten; der Code prüft sie gegen den Wortschatz des Vosk-Modells. Ergebnis pro Wort „passt / fast / nochmal“, keine Punktzahlen für Kinder; Grenzwerte zentral einstellbar; `PronunciationChecker` als austauschbare Schicht; Rückfall Server (Web, kein Sprachpaket). Phasen: Englisch-PoC + Test-Bildschirm (nur Entwickler-Build) → Sprachpakete laden/entfernen, Deutsch → FR, ES, IT, RU | 📋 PoC; ❓ `alphacephei.com` freischalten + Aufnahmen |
...
| Andere Anbieter                                     | **ein zweiter Anschluss für OpenAI-kompatible Schnittstellen** — damit gehen Mistral (Paris), IONOS / STACKIT / Scaleway (deutsche/europäische Hoster offener Modelle), Azure OpenAI (EU-Datenzone). Dann dieselben Tests gegen diese Modelle     | 📋 noch kein Code; ❓ Zugänge |
...
| Aussprache ohne Kosten                                                                                                                          | Vosk offline auf dem Handy (siehe §4)                     | 📋 Proof of Concept |
...
**Nachgetragen nach dem Abgleich (`docs/buddy/04-abgleich.md`):**

- Abo, Probezeit, Bezahlung — noch nicht geplant.
- Testphase mit verschiedenen Kindern (kostenlos): Ablauf, Einwilligung der Eltern, was wir messen.
- Prüfen, ob die Aufruf-Obergrenzen pro Tag intensives Üben blockieren — oder ob sie ganz wegfallen.
