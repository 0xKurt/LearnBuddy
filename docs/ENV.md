...
| `VERTEX_MODEL_ID`                     | `gemini-2.5-flash-lite` | Model for extraction / vision / regenerate. Cheap tier.                                                                                                                                                                                                                                                                                                                             |
| `VERTEX_TUTOR_MODEL_ID`               | `gemini-2.5-flash`      | Model for the conversational tutor + explain calls. flash-lite is too weak; this is the stronger tier per ADR 0002.                                                                                                                                                                                                                                                                 |
