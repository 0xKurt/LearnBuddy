...
export function costToCredits(input_tokens: number, output_tokens: number) {
  const cost_usd = (input_tokens / 1_000_000) * 0.1 + (output_tokens / 1_000_000) * 0.4;
...
```json
{
  ...
  "last_30_days": { "usd": 122.4, "calls": 9210 },
  "per_action": [
    { "reason": "vision", "calls": 1820, "usd": 31.2 },
    { "reason": "evaluation", "calls": 6900, "usd": 18.45 },
    { "reason": "regenerate", "calls": 410, "usd": 4.3 },
    { "reason": "explain", "calls": 80, "usd": 1.1 }
  ],
  "top_families_30d": [{ "account_id_hash": "...", "usd": 1.82, "tier": "plus" }],
  "prompt_versions": [{ "version": "p1.0", "calls": 9210, "usd": 122.4, "success_rate": 0.991 }]
}
```
