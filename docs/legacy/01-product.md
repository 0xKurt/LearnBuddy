...
When the account holder _is_ the learner (solo adult), this view is "looking at my own progress" and "managing my own account" — the same surface, but the framing is reflective rather than supervisory.
