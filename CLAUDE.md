...
Warm, calm, unfussy — not childish, not clinical (`docs/DESIGN-BRIEF.md`). Tokens in
`apps/mobile/lib/theme/colors.ts` and `lib/theme/type.ts` (one italic serif headline per screen);
