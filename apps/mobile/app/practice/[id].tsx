...
import { SolutionCard } from '../../components/practice/SolutionCard.js';
      ...
      >
        <ScrollView
          ...
          contentContainerStyle={{
            padding: 16,
            gap: 16,
            paddingBottom: open && !typed ? insets.bottom + 24 : 16,
          }}
          onContentSizeChange={() => {
        ...
        >
          ...
          />
          <QuestionCard prompt={item.prompt} topic={item.topic} />
