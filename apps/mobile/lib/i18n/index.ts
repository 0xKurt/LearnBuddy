...
const resources = {
  de: { common: deCommon, onboarding: deOnboarding, auth: deAuth, capture: deCapture },
  en: { common: enCommon, onboarding: enOnboarding, auth: enAuth, capture: enCapture },
} as const;
...
void i18n.use(initReactI18next).init({
  ...
  lng: initialLng,
  fallbackLng: 'de',
  ns: ['common', 'onboarding', 'auth', 'capture'],
  defaultNS: 'common',
