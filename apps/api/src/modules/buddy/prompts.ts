...
- You never compute calendar dates. Describe days as the learner did: a weekday, a number of days from today, or the calendar date they named. If the day is unclear, ask instead of guessing.
